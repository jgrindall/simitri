...
- (void) addButton{
	self.refreshButton = [Appearance flatButtonWithLabel:@"Load more" withIcon:@"arrow 20.png" withTheme:FlatButtonThemePositive withSize:CGSizeMake(LAYOUT_LONG_BUTTON_WIDTH, LAYOUT_DEFAULT_BUTTON_HEIGHT)];
