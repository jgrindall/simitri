...
- (void) addItems{
	self.egButton = [self addButtonWithLabel:@"Show example" clickSelector:@selector(egClicked) withTrailingSpace:YES withLeadingSpace:YES withSize:CGSizeMake(LAYOUT_LONG_BUTTON_WIDTH, LAYOUT_DEFAULT_BUTTON_HEIGHT) withIcon:@"pic.png" withTheme:FlatButtonThemeDefault];
